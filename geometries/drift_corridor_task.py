...
class DriftCorridorTask(QgsTask):
    ...
    corridors_generated = pyqtSignal(list)  # (list of corridor dicts)
    ...
    def run(self) -> bool:
        ...
        QgsMessageLog.logMessage(
            'Starting drift corridor generation...',
            'OMRAT',
            Qgis.Info
        )

        try:
            # Define progress callback that checks for cancellation
            ...
            # Run the actual corridor generation
    ...
    def finished(self, result: bool) -> None:
        ...
        """
        if result:
            # Success - emit signal with corridors
    ...
    def cancel(self) -> None:
        ...
        This sets the cancellation flag which is checked during generation.
        """
        QgsMessageLog.logMessage(
